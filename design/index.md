...
+ [事务性业务操作的典型场景](http://47.92.67.238:7080/res/docs/practice1.pdf)
...
+ ID标识。必须能够进行ID标识。
+ 计算能力。有一定的计算能力。常见的以Android、iOS、Linux、MacOS、Windows为操作系统的均可。
...
用友云平台为多端接入提供了大量标准能力，让用户可以一分钟快速接入设备
...
多端设备接入，首先要集成CoreSDK。CoreSDK提供多项基本能力
...
+ [人脸认证](http://www.baidu.com)
+ [文件共享](http://www.baidu.com)
+ [扫描](http://www.baidu.com)
+ [投屏](http://www.baidu.com)
+ [摄像头访问](http://www.baidu.com)
+ [消息模版](http://www.baidu.com)
+ [云打印](http://www.baidu.com)
